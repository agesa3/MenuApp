package com.example.menuapp.sample;
...
static {
    ...
    addItem(new DataItem(null, "Quinoa Salmon Salad", "Salads", "Our quinoa salad is served with quinoa, tomatoes, cucumber, scallions, and smoked salmon. Served with your choice of dressing.",
